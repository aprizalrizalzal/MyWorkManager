package me.aprizal.myworkmanager;
...
public class MyWorker extends Worker {
    ...
    private static final String APP_ID = "b73455de914a7280ffae82d716064c11";
    ...
    private Result getCurrentWeather(String dataCity) {
        Log.d(TAG, "getCurrentWeather: Mulai.....");
        Looper.prepare();
        SyncHttpClient client = new SyncHttpClient();
        String url = "http://api.openweathermap.org/data/2.5/weather?q=" + dataCity + "&appid=" + APP_ID;
...
//                    double tempInKelvin = responseObject.getJSONObject("main").getDouble("temp");
                    ...
                    String title = "Current Weather in " + dataCity;
